const homeData = {
  title: "Hi, I’m Abdul Karim Sulaeman 👋",
  typingTexts: [
    "Frontend Developer",
    "React Enthusiast ⌘",
    "Tailwind Warrior",
    "UI/UX Explorer",
    "Passionate Vocational High School",
  ],
  description:
  ...
  buttons: [
    {
      ...
      href: "https://github.com/karimm1620",
      type: "primary",
    },
    {
      label: "Download My CV",
      href: "https://drive.google.com/uc?export=download&id=1ddrLAu7tP8M_yLzNpnqZt5ffjtWjuCHh",
      type: "secondary",
    },
  ],
  floatingIcons: [
