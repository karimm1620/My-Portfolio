        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center py-12 min-h-[calc(100vh-5rem)]">
          ...
          >
            <img
              src={aboutData.image}
              alt="About Me"
              className="w-full max-w-md rounded-xl shadow-lg object-cover border-8 border-white dark:border-gray-800 hover:shadow-3xl hover:-translate-y-2 transition-all duration-300"
            />
          </div>
          ...
          <div className="w-full text-gray-800 dark:text-white">
            ...
            >
              <i
                className="bx bx-info-circle text-2xl text-gray-800 dark:text-white"
                aria-hidden="true"
              ></i>
